...
translations = {
    ...
    "Review one-time reminders that are already past due.": "Просмотрите одноразовые напоминания, которые уже просрочены.",
    ...
    "If a recurring event was missed, skip it and schedule the next occurrence": "Если повторяющееся событие пропущено, пропустить его и запланировать следующее",
    ...
    "One-time reminders that were missed and now need manual review.": "Одноразовые напоминания, которые были пропущены и требуют ручной проверки.",
    "Overdue": "Просрочено",
    ...
    "When a one-time reminder is missed, it will appear here instead of firing automatically.": "Когда одноразовое напоминание пропущено, оно появится здесь вместо автоматического срабатывания.",
    "%1 d %2 h late": "%1 дн %2 ч назад",
    "%1 h %2 min late": "%1 ч %2 мин назад",
    "%1 min late": "%1 мин назад",
}
